...
World::build(void) {
  // view plane  
  vplane.top_left.x = -80;
  vplane.top_left.y = 80;
  vplane.top_left.z = 100;
  vplane.bottom_right.x = 80;
  vplane.bottom_right.y = -80;
  ...
  // // camera facing plane
  // Plane* plane_ptrz = new Plane(Point3D(0, 0, -300), Vector3D(0, 0, 1));
  // plane_ptrz->set_material(new Glass(grey));
  // add_geometry(plane_ptrz);
}
