...
class AntiAliasing: public Tracer {
protected:
...
public:
  // Constructors.
  AntiAliasing();     // initialize members.
  AntiAliasing(int);  // initialize members.
  AntiAliasing(int, int);  // initialize members.

  // Destructor.
  ~AntiAliasing(); // free memory.
