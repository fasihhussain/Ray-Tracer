...
void World::build(void)
{
    ...
    for (size_t i = 0; i < fInd.size(); i++)
    {
        ...
        Point3D v1 = points[faceIndices[1]];
        Point3D v2 = points[faceIndices[2]];
        Vector3D v1_n = normals[faceIndices[0]];
        Vector3D v2_n = normals[faceIndices[1]];
        Vector3D v3_n = normals[faceIndices[2]];
        CurvedTriangle *triangle = new CurvedTriangle(v0, v1, v2, v1_n, v2_n, v3_n);
